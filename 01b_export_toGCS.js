...
var address = 'projects/mapbiomas-workspace/DEGRADACAO/COLECAO/BETA/PROCESS/native_mask/wetlandMask_col11_v1';

// output bucket 
var bucket_name = 'shared-development-storage';
var bucket_address = 'AUXILIARES/DEGRADACAO/COL_11/temp_wetland/';
...
exporting(nativeMask ,'wetland');
print('wetland', nativeMask);
