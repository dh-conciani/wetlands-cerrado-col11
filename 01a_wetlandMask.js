...
Export.image.toAsset({
	image: recipe,
  description: 'wetlandMask_' + 'col11_v' + version,
  assetId: 'projects/mapbiomas-workspace/DEGRADACAO/COLECAO/BETA/PROCESS/native_mask/' + 'wetlandMask_' + 'col11_v' + version,
